    ...
    <div class="lg-document-editor" :class="{ disabled: disabled }">
        ...
        <div v-if="!hideToolbar" class="editor-toolbar">
            ...
            <div class="toolbar-group">
                <button type="button" class="toolbar-btn" :class="{ active: formatState.bold }"
                    @click="execCommand('bold')" title="Negrito (Ctrl+B)">
                    <strong>B</strong>
                </button>

                <button type="button" class="toolbar-btn" :class="{ active: formatState.italic }"
                    @click="execCommand('italic')" title="Itálico (Ctrl+I)">
                    <em>I</em>
                </button>

                <button type="button" class="toolbar-btn" :class="{ active: formatState.underline }"
                    @click="execCommand('underline')" title="Sublinhado (Ctrl+U)">
                    <u>U</u>
                </button>
            </div>
            ...
            <div class="toolbar-group">
                ...
                <button type="button" class="toolbar-btn" @click="execCommand('justifyCenter')" title="Centralizar">
                    ≡
                </button>

                <button type="button" class="toolbar-btn" @click="execCommand('justifyRight')"
            ...
            <div v-if="variables && variables.length > 0" class="toolbar-group">
                <select class="variable-select" @change="insertVariableFromSelect" title="Inserir variável">
            ...
            <div class="toolbar-separator"></div>
            <div class="toolbar-group">
                <button type="button" class="toolbar-btn" @click="undo" title="Desfazer (Ctrl+Z)">
                    ↶
                </button>

                <button type="button" class="toolbar-btn" @click="redo" title="Refazer (Ctrl+Y)">
                    ↷
                </button>
            </div>
            ...
            <div class="toolbar-separator"></div>
            <div class="toolbar-group">
                <button type="button" class="toolbar-btn" @click="execCommand('removeFormat')"
        ...
        <!-- Editor content -->
        <div ref="editorRef" class="editor-content" contenteditable="true" :style="editorStyle" @input="handleInput"
            @keydown="handleKeydown" @mouseup="updateFormatState" @keyup="updateFormatState" @paste="handlePaste"></div>
