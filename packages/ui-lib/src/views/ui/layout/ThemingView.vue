    ...
    <div class="theming-view">
        <div class="view-header">
            ...
            <p class="view-description">
                Explore e teste todos os temas disponíveis na biblioteca. Clique em um tema para aplicá-lo em tempo
                real.
            </p>
        </div>
        ...
        <!-- ============================================ -->
        <ComponentShowcase title="Temas Disponíveis"
            ...
            <template #preview>
                <div class="themes-grid">
                    <div v-for="theme in themes" :key="theme.name" class="theme-card"
                        :class="{ active: currentTheme === theme.name }" @click="setTheme(theme.name)" role="button"
                        tabindex="0" :aria-label="`Aplicar tema ${theme.displayName}`">
                        <div class="theme-preview">
                            <div class="color-sample" :style="{ backgroundColor: themeColors[theme.name].background }"
                                title="Background"></div>
                            <div class="color-sample" :style="{ backgroundColor: themeColors[theme.name].text }"
                                title="Text"></div>
                            <div class="color-sample" :style="{ backgroundColor: themeColors[theme.name].primary }"
                                title="Primary"></div>
                            <div class="color-sample" :style="{ backgroundColor: themeColors[theme.name].border }"
                                title="Border"></div>
                            <div class="color-sample" :style="{ backgroundColor: themeColors[theme.name].accent }"
                                title="Accent"></div>
                        </div>
